...
class TemplateFactory {
	...
	static String usecaseTemplate(String featureName, String epic, Boolean withFolder = true) {
		...
		String importScreenPath = "features.${epicLowercase}.${epic}Screen"

		if (withFolder) {
			packageNamePath = "package features.${featureName.toLowerCase()}.${epicLowercase}.usecase"
...
"""
	...
	static String stepTemplate(String featureName, String epic, Boolean withFolder = true) {
		...
		String importUsecasePath = "features.${epicLowercase}.${epic}Usecase"

		if (withFolder) {
			packageNamePath = "package features.${featureName.toLowerCase()}.${epic.toLowerCase()}.stepDef"
